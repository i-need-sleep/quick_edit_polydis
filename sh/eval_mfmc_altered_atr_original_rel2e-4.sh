#!/bin/bash
#SBATCH --job-name=eval_mfmc_altered_atr_original_rel_2e-4_cont19_       # 任务名
...
python -u train.py \
    --name train_mfmc_altered_atr_original_rel_2e-4_cont19_ \
    --lr 2e-4 \
    --edit_scheme mfmc \
    --altered_atr_original_rel \
    --checkpoint ../results/checkpoints/train_mfmc_altered_atr_original_rel_2e-4_cont19_/batchsize48_lr0.0002_0_1999_0.bin \
    --batch_size 1 \
    --eval
echo "FINISH"                       # 输出起始信息
