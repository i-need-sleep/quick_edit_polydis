#!/bin/bash
#SBATCH --job-name=train_mfmc_altered_atr_original_rel_2e-4_fixed_cont17_       # 任务名
...
python -u train.py \
    --name train_mfmc_altered_atr_original_rel_2e-4_fixed_cont17_ \
    --lr 2e-4 \
    --edit_scheme mfmc \
    --altered_atr_original_rel \
    --checkpoint ../results/checkpoints/train_mfmc_altered_atr_original_rel_2e-4_fixed_cont17_/batchsize48_lr0.0002_0_3999_0.bin
echo "FINISH"                       # 输出起始信息
