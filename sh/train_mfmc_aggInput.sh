#!/bin/bash
#SBATCH --job-name=train_mfmc_aggInput_cont5_       # 任务名
...
python -u train.py \
    --name train_mfmc_aggInput_cont5_ \
    --lr 1e-3 \
    --edit_scheme mfmc \
    --include_original_notes \
    --checkpoint ../results/checkpoints/train_mfmc_aggInput_cont4_/batchsize48_lr0.001_0_3999_0.bin
echo "FINISH"                       # 输出起始信息
