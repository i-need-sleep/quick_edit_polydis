...
class EditMuseBERT(torch.nn.Module):
    def __init__(self, device, pretrained_path='../pretrained/musebert.pt', n_edit_types=128):
...
class EditMuseBERTDecoder(torch.nn.Module):
    def __init__(self, device, n_decoder_layers=1):
        super(EditMuseBERTDecoder, self).__init__()
