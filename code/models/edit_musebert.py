...
class EditMuseBERT(torch.nn.Module):
    def __init__(self, device, pretrained_path='../pretrained/musebert.pt', n_edit_types=128, n_decoder_layers=1):
        ...
        self.n_inserts_head = torch.nn.Linear(128, 8) # num of inserts at each onset step
    ...
    def encode(self, data_in, rel_mat_in, z_chd, length):
        ...
        return edits_out, n_inserts_out
