...
import os
import pandas as pd
from models.polydis.score import PolyphonicMusic
from torch.utils.data import DataLoader
from models.polydis.converter import ext_nmat_to_pr, ext_nmat_to_mel_pr, \
    augment_pr, augment_mel_pr, pr_to_onehot_pr, piano_roll_to_target, \
    target_to_3dtarget, expand_chord


DATA_PATH = os.path.join('../data/pop_909', 'POP09-PIANOROLL-4-bin-quantization')
INDEX_FILE_PATH = os.path.join('../data/pop_909', 'index.xlsx')
SEED = 3345
...
class ArrangementDataset(Dataset):
    ...
    def __getitem__(self, id):
        ...
        if self.contain_chord:
            ...
            return mel_segments, prs, pr_mats, p_grids, chord
        else:
