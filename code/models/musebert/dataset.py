...
from models.musebert.amc_dl.torch_plus import DataLoaders
...
from models.musebert.utils import augment_note_matrix
...
class NoteMatrixDataset:
    ...
    train_path = '../data/musebert/nmat_train.npy'
    train_length_path = '../data/musebert/nmat_train_length.npy'
    val_path = '../data/musebert/nmat_val.npy'
    val_length_path = '../data/musebert/nmat_val_length.npy'
    pad_length = 100
